export const htmlEmail = (name, message) => {
  ...
  return (
    <div style={{ fontFamily: `'Courier New', sans-serif, 'Open Sans'` }}>
      ...
      <h1>Hello {name}</h1>
      <p>This is a confirmation, that your message to app.christof.digital has indeed been received sucessfully.<br />I&apos;ll come back to you as soon as possible.</p>
