  ...
  return (
    ...
    text-gray-500 transition-all border-t border-black border-opacity-10
      ...
      <a href='https://www.christof.digital/coding' className='absolute left-0' aria-label='Back Home'>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9 hover:text-brand-dark dark:hover:text-brand transition-colors cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
